...
CORS_ALLOWED_ORIGINS = [
    'http://127.0.0.1:8000', 'https://makers-firefighters.web.app/', 'http://localhost:3000', 
]
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 20, 'DEFAULT_AUTHENTICATION_CLASSES': ('rest_framework_simplejwt.authentication.JWTAuthentication',
    )
}
